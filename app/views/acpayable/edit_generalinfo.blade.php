            ...
            switch($form->payable_type)
            {
                case "SwiftOrder":
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10 editable-select2">
                            <a href="#" id="generalinfo_charge_{{ $form->id }}" class="editable" data-type="select" data-name="type" data-pk="{{ Crypt::encrypt($form->id) }}" data-context="generalinfo" data-url="/{{ $rootURL }}/general-info" data-value="{{ $form->type }}" data-source='{{$type_order}}'></a>
                        </div>
                    </div>
                    <?php
                    break;
