@if(!$too_many_late_nodes)
    ...
    @endif
@else
    <h2 class="text-center">Too many late nodes! <br/>
        <small>Due to server throttling, we are unable to display the late nodes at this time.</small>
    </h2>
@endif