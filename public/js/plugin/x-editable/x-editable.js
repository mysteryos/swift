...
(function ($) {
       ...
       //collect text of checked boxes
        value2htmlFinal: function(value, element) {
           ...
           if(checked.length) {
               ...
               $(element).html(html.join(this.options.htmlSeparator));
           } else {
               $(element).empty(); 
           }
        },
    ...
    Checklist.defaults = $.extend({}, $.fn.editabletypes.list.defaults, {
        ...
        **/         
        ...
        /**
         Seperator of Values when displaying list
        @property html separator
        @type string
        @default ', '
         */
        htmlSeperator: ', '
...
(function ($) {
    ...
    DateField.defaults = $.extend({}, $.fn.editabletypes.date.defaults, {
        ...
        @property tpl 
        **/         
        tpl:'<div class="input-append date input-group"><input type="text"/><span class="add-on input-group-addon"><i class="fa fa-calendar"></i></span></div>',
        /**
        @property inputclass 
        @default 'input-small'
        **/         
...
(function ($) {
    ...
    $.extend(DateTime.prototype, {
        initPicker: function(options, defaults) {
            ...
            if (this.options.value === undefined || this.options.value === null) {
                this.options.value = this.input.html2value($.trim(this.$element.html()));
            }
