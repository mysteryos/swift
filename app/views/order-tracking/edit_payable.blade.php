...
<div class="modal fade" id="payableFormModal" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
            ...
            <form action="/accounts-payable/saveByForm" name="payable_form" method="POST" class="form-horizontal" id="payableForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="hidden" class="full-width" id="companycode" name="company_code" placeholder="Type in the supplier's name/code" />
                        </div>
                    </div>
                    <div class="form-group">
