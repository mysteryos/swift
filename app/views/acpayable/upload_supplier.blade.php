        ...
        <div class="row dz-success" data-id="{{Crypt::encrypt($d->id)}}" data-name="{{$d->getAttachedfiles()['document']->originalFilename()}}">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-2 @if(!$isCreator && !$permission->isAdmin()) hide @endif">
                ...
                <div class="col-xs-12">
                    <div class="col-xs-10">
                        <i class="fa fa-tags"></i>&nbsp;
                                ...
                                ?>" data-source='{{ $tags }}' data-emptytext="No tags" data-name="type" data-mode="popup" data-placement="bottom" data-type="checklist" data-url="/{{ $rootURL }}/supplier-tag" data-pk="{{Crypt::encrypt($d->id)}}" class="editable tags"></a>
                    </div>
                </div>
            </div>
        </div>
...
<div id="template" class="row">
    ...
    <div class="col-xs-6">
        ...
        <div class="row">
            <div class="col-xs-12">
                <i class="fa fa-tags"></i>&nbsp;
                <a data-title="Select Tags" data-value="" data-emptytext="No tags" data-name="type" data-mode="popup" data-source='{{ $tags }}' data-type="checklist" data-url="/{{ $rootURL }}/supplier-tag" data-pk="0" class="editable tag dummy hide"></a>
            </div>
        </div>
    </div>
    <div class="col-xs-4">
