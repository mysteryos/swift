@if(isset($in_progress_count))
    <div class="smart-accordion-default panel-group panel-compressed">
        @if(count($order_inprogress_important_responsible))
                ...
                <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" href="#order_inprogress_important_responsible" class="txt-color-red">
                                ...
                                <i class="fa fa-warning"></i> Important (<small class="num-of-tasks">{{ count($order_inprogress_important_responsible) }}</small>)
                            </a>
                        </h4>
                </div>
        ...
        @endif
        @if(count($order_inprogress_responsible))
            <div class="panel panel-default">
                <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" href="#order_inprogress_responsible" class="txt-color-orangeDark">
                                <i class="fa fa-lg fa-angle-down pull-right"></i>
                                <i class="fa fa-lg fa-angle-up pull-right"></i>
                                <i class="fa fa-clock-o"></i> In Progress (<small class="num-of-tasks">{{ count($order_inprogress_responsible) }}</small>)
                            </a>
                        </h4>
                </div>
                <div class="panel-collapse collapse in" id="order_inprogress_responsible">
                    <div class="panel-body no-padding">
                        <table class="table table-striped table-hover table-responsive">        
                        @foreach($order_inprogress_responsible as $or)
                            <tr>
                                    <td>
        ...
        @endif
        @if(count($order_inprogress_important))
            <div class="panel panel-default">
                <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" href="#order_inprogress_important" class="txt-color-purple">
                                <i class="fa fa-lg fa-angle-down pull-right"></i>
                                <i class="fa fa-lg fa-angle-up pull-right"></i>
                                <i class="fa fa-exclamation"></i> Other Important (<small class="num-of-tasks">{{ count($order_inprogress_important) }}</small>)
                            </a>
                        </h4>
                </div>
                <div class="panel-collapse collapse in" id="order_inprogress_important">
                    <div class="panel-body no-padding">
                        <table class="table table-striped table-hover table-responsive">        
                        @foreach($order_inprogress_important as $oi)
                            <tr>
                                    <td>
                ...
                <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" href="#order_inprogress">
                                <i class="fa fa-lg fa-angle-down pull-right"></i>
                                <i class="fa fa-lg fa-angle-up pull-right"></i>
                                <i class="fa fa-map-marker"></i> Other (<small class="num-of-tasks">{{ count($order_inprogress) }}</small>)
                            </a>
                        </h4>
                </div>
