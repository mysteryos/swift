                ...
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        @foreach($f->purchaseOrder as $po)
                            <p>{{$po->reference}} {{$po->type}} @if($po->validated === \SwiftPurchaseOrder::VALIDATION_FOUND)<a href="/jde-purchase-order/view-by-form/{{\Crypt::encrypt($po->id)}}" class="purchase-order-view colorbox-ajax"><i class="fa fa-search"></i> View</a></p>@endif
                        @endforeach
                        </td>
                    </tr>
                    <tr>
