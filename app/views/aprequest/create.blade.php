...
<div id="ribbon">
        ...
        <div class="ribbon-button-alignment">
            <ol class="breadcrumb"><li>Home</li><li>A&P Request</li><li>Create</li></ol>            
        </div>
...
<!-- MAIN CONTENT -->
<div id="content" data-js="apr_create" data-urljs="{{ Bust::url('/js/swift/swift.apr_create.js')}}">
    <div class="row">
			...
			<div class="jarviswidget" id="widget-form" data-widget-deletebutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-togglebutton="false" data-widget-sortable="false">
				...
				<div>
					...
					<div class="widget-body no-padding">
                                            <form action="/aprequest/create" method="POST" id="aprequest-create-form" enctype="multipart/form-data" class="form-horizontal" name="aprequest-create" novalidate="novalidate">                                            
									...
									<div class="panel-body">
                                                                                        <fieldset>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <div class="col-md-10">
                                                                                                        <input type="hidden" class="full-width" id="ccode" name="customer_code" placeholder="Type in the customer's name/code" />
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="form-group">
