...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Scott - Comment Mention</title>
                          ...
                          <tr>
                             <td height="47" valign="bottom" width="236">
                                 <a href="http://swift.scottltd.net" target="_blank">
                                     <img style="VERTICAL-ALIGN:bottom;" border="0" alt="Scott & co Ltd" src="http://swift.scottltd.net/img/logo.png" width="236" height="47">
                                 </a>
                             </td>
                             ...
                             <td>
                                <table border="0" cellspacing="0" cellpadding="0" width="620" align="center">
                                   <tbody>
                                      ...
                                      <tr>
                                         <td style="LINE-HEIGHT:32px;FONT-FAMILY:arial;COLOR:#f60;FONT-SIZE:24px;" valign="top">Comment Tag</td>
                                      </tr>
                                      <tr>
                                         <td height="14">&nbsp;</td>
                                      </tr>
