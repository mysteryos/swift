<fieldset data-name="reception" class="fieldset-reception multi @if(isset($dummy) && $dummy == true) dummy hide @endif " >
    ...
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <div class="col-md-8">
                    <a href="#" @if(isset($r->id)) {{ "id=\"reception_reception_user_".Crypt::decrypt($r->id)."\"" }} @endif data-type="text"  class="editable reception-editable @if(isset($dummy) && $dummy == true) dummy @endif" data-context="reception" data-pk="{{ $r->id or 0 }}" data-name="reception_user" data-url="/order-tracking/reception/{{ Crypt::encrypt($order->id) }}" data-value="{{ $r->reception_user or "" }}"></a>
            </div>
        </div>
        <div class="form-group col-md-6">
