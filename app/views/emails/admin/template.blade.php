...
<head>
    ...
    <title>Scott Swift - Admin Utility</title>
                ...
                <tr>
                    <td>
                        <table border="0" cellspacing="0" cellpadding="0" width="620" align="center">
                            ...
                            <tr>
                                <td style="LINE-HEIGHT:32px;FONT-FAMILY:arial;COLOR:#f60;FONT-SIZE:24px;" valign="top">Admin Utility</td>
                            </tr>
                            <tr>
                                <td height="14">&nbsp;</td>
                            </tr>
                            <tr>
                                <td style="LINE-HEIGHT:40px;FONT-FAMILY:arial;COLOR:#666;FONT-SIZE:18px;" valign="top">{{$note}}</td>
                            </tr>
                            </tbody>
                        </table>
