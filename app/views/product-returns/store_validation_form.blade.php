    ...
    <div id="pr_form_{{$form->id}}" class="panel-collapse collapse">
        <div class="panel-body no-padding">
            <div class="well data-container">
                <h2><i class="fa fa-beer"></i> Products <a class="btn btn-success btn-publish row-space-left-2" href="/{{ $rootURL }}/publish-store-validation/{{$form->encrypted_id}}""><i class="fa fa-share fa-lg"></i> Publish</a></h2>
