<fieldset data-name="general_info">
        ...
        <div class="form-group">
                ...
                <div class="col-md-10">
                    <a href="#" id="generalinfo_notes_{{ $form->id }}" class="editable" data-type="select" data-name="has_budget" data-pk="{{ Crypt::encrypt($form->id) }}" data-context="generalinfo" data-url="/{{ $rootURL }}/scheme-generalinfo"  data-title="Select validity of budget" data-value="{{ $form->has_budget or "" }}" data-source='{{ $budget_list }}'></a>
                </div>        
        </div>
</fieldset>