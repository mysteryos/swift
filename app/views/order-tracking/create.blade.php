...
<div id="ribbon">
        ...
        <div class="ribbon-button-alignment">
            <ol class="breadcrumb"><li>Home</li><li>Order Process</li><li>Create</li></ol>            
        </div>
...
<!-- MAIN CONTENT -->
<div id="content" data-js="ot_create">
    <div class="row">
...
<!--                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <div class="col-md-10">
                                                                                                        <input type="hidden" name="supplier_id" id="suppliersearch" value="" class="col-xs-12 no-padding" />
                                                                                                    </div>
                                                                                                </div>-->
                                                                                        </fieldset>
                                                                        </div>
