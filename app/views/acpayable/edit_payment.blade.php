<fieldset data-name="payment" class="fieldset-payment multi @if(isset($dummy) && $dummy == true) dummy hide @endif ">
    ...
    <div class="row payment-1" @if(!isset($pay->type) || $pay->type !== \SwiftACPPayment::TYPE_CHEQUE) style="display:none;" @endif>
        <div class="form-group col-lg-6 col-xs-12" @if(!isset($pay->type) || $pay->type !== \SwiftACPPayment::TYPE_CHEQUE) style="display:none;" @endif>
        ...
        <div class="form-group col-lg-6 col-xs-12">
            ...
            <div class="col-md-10">
                <a href="#" @if(isset($pay->id)) {{ "id=\"payment_cheque_dispatch_".Crypt::decrypt($pay->id)."\"" }} @endif class="editable @if(isset($dummy) && $dummy == true) dummy @endif @if(!$isAdmin && !$isAccountingDept) editable-disabled @endif" data-type="text" data-name="cheque_dispatch" data-pk="{{ $pay->id or 0 }}" data-context="payment" data-url="/{{ $rootURL }}/payment/{{ Crypt::encrypt($form->id) }}" data-value="{{ $pay->cheque_dispatch or "" }}"></a>
            </div>
        </div>
        <div class="form-group col-lg-6 col-xs-12">
