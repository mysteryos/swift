<fieldset data-name="reception" class="fieldset-reception multi @if(isset($dummy) && $dummy == true) dummy hide @endif " >
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <a href="#" class="editable reception-editable @if(isset($dummy) && $dummy == true) dummy @endif" data-type="text" data-name="grn" data-pk="{{ $r->id or 0 }}" data-url="/order-tracking/reception/{{ Crypt::encrypt($order->id) }}" data-value="{{ $r->grn or "" }}"></a>
            </div>                                                                                        
        </div>
    </div>
    <div class="row">
