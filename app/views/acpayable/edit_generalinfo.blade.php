<fieldset data-name="general_info">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10 editable-select2">
                <a href="#" id="generalinfo_supplier_{{ $form->id }}" class="editable" data-type="select2" data-name="supplier_code" data-pk="{{ Crypt::encrypt($form->id) }}" data-context="generalinfo" data-url="/{{ $rootURL }}/generalinfo" data-value="{{ $form->supplier_code }}" data-placeholder="Select a supplier">{{ $form->supplier_name }}</a>
            </div>
        </div>
        <div class="form-group">
