<fieldset data-name="payment-voucher" class="fieldset-paymentvoucher multi @if(isset($dummy) && $dummy == true) dummy hide @endif ">
    <div class="row">
        <div class="form-group col-xs-6">
            <label class="col-md-4 control-label"><strong>Payment Voucher*</strong></label>
            <div class="col-md-8">
        ...
        <div class="form-group col-xs-6">
            ...
            <div class="col-md-8">
                <a href="#" @if(isset($pv->id)) {{ "id=\"paymentvoucher_type_".$pv->id."\"" }} @endif class="editable paymentvoucher-editable @if(isset($dummy) && $dummy == true) dummy @endif" data-type="select" data-context="paymentvoucher" data-name="type" data-source='{{$pv_type}}' data-pk="{{ $pv->encrypted_id or 0 }}" data-url="/{{ $rootURL }}/paymentvoucher/{{ $form->encrypted_id }}" data-value="{{ $pv->type or \SwiftACPPaymentVoucher::TYPE_PV }}"></a>
            </div>
        </div>
    </div>
    <div class="row">
